...
@Component({
  selector: 'app-places',
  imports: [SearchBar, TripCard, RouterLink],
  template: `
    ...
    <div class="flex justify-between items-baseline gap-2">
      ...
      <button role="tab" class="btn btn-primary btn-sm" routerLink="/places/trip-form">
        Add Place
      </button>
    </div>
  ...
  trips = signal<Trip[]>([
    {
      ...
      coverImageUrl:
        'https://images.unsplash.com/photo-1562979314-bee7453e911c?q=80&w=1674&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
      ...
      coverImageUrl:
        'https://images.unsplash.com/photo-1596176530529-78163a4f7af2?q=80&w=2127&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
      ...
      coverImageUrl:
        'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?q=80&w=1773&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
      ...
      coverImageUrl:
        'https://plus.unsplash.com/premium_photo-1697729729075-3e56242aef49?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    ...
    },
    {
      ...
      location: 'Goa, India',
      coverImageUrl:
        'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?q=80&w=1674&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
